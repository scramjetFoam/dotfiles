function install_brew_apps {
  ...
  brew install aria2 cpulimit duti exiftool ffmpeg geckodriver gifski git handbrake haskell-stack hr imagemagick jq mas massren mediainfo megatools mkvtoolnix mp4v2 mpv neovim pup ripgrep rmlint shellcheck sox svgcleaner trash tree youtube-dl z zsh
  ...
  brew install alfred-placeholder-workflows alfred-rebuild-notificator alfred-rebuild-sharedresources alfred-workflow-update alfred-workflows-renamer cask-analytics cask-repair climergebutton contagem-edp gfv human-media-time labelcolor lossless-compress lovecolor macspoof makeicns pedir-gas pinboardbackup pinboardlinkcheck pinboardurlupdate pinboardwaybackmachine podbook progressbar ringtonemaker rtp-download seren trello-purge-archives upload-file
}
...
function install_mas_apps {
  ...
  local mas_apps=('1password=443987910' 'affinity-designer=824171161' 'affinity-photo=824183456' 'clear=504544917' 'colorsnapper2=969418666' 'dropshelf=540404405' 'haskell=841285201' 'ia-writer=775737590' 'quiver=866773894' 'reeder=880001334' 'spark=1176895641' 'trello=1278508951' 'tweetbot=557168941' 'wipr=1320666476' 'xcode=497799835')
